...
<body>
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.3s">
                            <form method="post">
                                <div class="row g-3">
                                    ...
                                    <!-- print name , hosptital name and description  -->
                                    <!-- table of records  -->
                                    <?php
                                    // get records 
                                        $sql = "SELECT * FROM records WHERE patientId = '$patient_id'";
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <a href="record.php?recordId=<?php echo $row['recordId'];?>">

                                                <td id="recordId"><a
                                                        href="record.php?recordId=<?php echo $row['recordId'];?>"><?php echo  $row['recordId'];?></a>
                                                </td>
                                                <td id="recordName"><?php echo $row['patientName'];?></td>

                                                <td id="recordHospital"><?php echo $row['hospitalName'];?></td>
                                                <td id="recordDoctor"><?php echo $row['doctorName'];?></td>
                                                <td id="recordDate"><?php echo $row['date'];?></td>
                                            </a>
                                        </tr>
    ...
    <!-- <script src="fetchbundle.js?v=1"></script> -->
</body>
